...
userInput.addEventListener("input", (e) => {
    localStorage.setItem("geminiApiPromptGenerator", JSON.stringify(e.target.value));
    userInputTextareaAutoResize(chatBoxTextarea)
});
const geminiApiPromptGenerator = JSON.parse(localStorage.getItem("geminiApiPromptGenerator"));
if (geminiApiPromptGenerator) {
    userInput.value = geminiApiPromptGenerator;
    userInputTextareaAutoResize(chatBoxTextarea)
}
...
const backendAPI = "/data_sets/gemini-api-prompt-generator-ds-api/";
...
sendButton.addEventListener("click", () => {
    ...
    userInput.value = "";
    localStorage.removeItem("geminiApiPromptGenerator");
    userInputTextareaAutoResize(chatBoxTextarea)
});
