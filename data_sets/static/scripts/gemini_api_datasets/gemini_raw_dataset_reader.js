document.addEventListener("DOMContentLoaded", () => {
    ...
    userInput.addEventListener("input", (e) => {
        localStorage.setItem("geminiApiRawDsReader", JSON.stringify(e.target.value));
        userInputTextareaAutoResize(chatBoxTextarea)
    });
    const geminiApiRawDsReader = JSON.parse(localStorage.getItem("geminiApiRawDsReader"));
    if (geminiApiRawDsReader) {
        userInput.value = geminiApiRawDsReader;
        userInputTextareaAutoResize(chatBoxTextarea)
    }
    ...
    const backendAPI = "/data_sets/gemini-raw-dataset-reader-api/";
    ...
    sendButton.addEventListener("click", () => {
        ...
        userInput.value = "";
        localStorage.removeItem("geminiApiRawDsReader");
        userInputTextareaAutoResize(chatBoxTextarea)
    });
