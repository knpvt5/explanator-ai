document.addEventListener("DOMContentLoaded", () => {
    ...
    userInput.addEventListener("input", (e) => {
        localStorage.setItem("nvidiaApiRawDsReader", JSON.stringify(e.target.value));
        userInputTextareaAutoResize(chatBoxTextarea)
    });
    const nvidiaApiRawDsReader = JSON.parse(localStorage.getItem("nvidiaApiRawDsReader"));
    if (nvidiaApiRawDsReader) {
        userInput.value = nvidiaApiRawDsReader;
        userInputTextareaAutoResize(chatBoxTextarea)
    }
